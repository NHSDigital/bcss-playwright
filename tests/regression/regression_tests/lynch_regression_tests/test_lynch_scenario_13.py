...
def test_lynch_scenario_13(page: Page) -> None:
    """
    Scenario: 13 - Abnormal result from diagnostic tests (over-age)

    G1-G2-G3-A183-A25-J10-A99-A59-A259-A315-A361-A323-A317-A318-A65-Lynch above age [SSCL11e]

    This scenario tests progression of a Lynch episode for an over-age subject to closure on A65 Abnormal from diagnostic test results (but not symptomatic procedure results).
