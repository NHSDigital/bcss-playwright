...
def test_lynch_scenario_17(page: Page) -> None:
    """
    Scenario: 17 - High-risk findings result from symptomatic procedure

    G1-G2-G3-A183-A25-J10-A99-A59-A259-A361-A323-A317-A353-A372-A373-A377-A158-Lynch in age [SSCL53c]
    ...
    # And I set the Date of Symptomatic Procedure to "7 days ago"
    HighRiskFindingsResultFromSymptomaticProcedure(
        page
    ).enter_date_of_symptomatic_procedure(datetime.today() - timedelta(days=7))
    ...
    subject_assertion(
        nhs_no,
        {
            ...
            "symptomatic procedure date": "7 days ago",
