...
def test_lynch_scenario_18(page: Page) -> None:
    """
    Scenario: 18 - Close on existing Abnormal result (no contact)

    G1-G2-G3-A183-A25-J10-A99-A59-A259-A315-A361-A323-A317-A318-A395-A99-A59-A259-A315-A361-A323-A317-A318-A380-A400-A65-C203-[SSCL10g]

    In this scenario, the subject has two diagnostic tests, one complete and one failed test, both of which give Abnormal results.  Contact with the subject is then lost, and the episode is closed on the existing Abnormal result.
    ...
    > Record no contact with Patient > A400 (2.2)
    > Process A400 letter batch > A65 (2.2)
    ...
    # And there is a "A400" letter batch for my subject with the exact title "Follow-up Test Cancelled by Screening Centre (Lynch)"
    # When I process the open "A400" letter batch for my subject
    batch_processing(
        page, "A400", "Follow-up Test Cancelled by Screening Centre (Lynch)"
    )
