...
def test_lynch_scenario_3(page: Page) -> None:
    ...
    G1-G2-G3-A183-A25-J11-J27-A184-A26-A185-A37-A166-C203 in age range [SSCL4b(A166)]
    ...
    # And I receive an SSPI update to change their date of birth to "28" years old
    SSPIChangeSteps().sspi_update_to_change_dob_received(nhs_no, 28)
    ...
    batch_processing(
        page, "A37", "GP Discharge (Non Attendance of Practitioner Clinic) (Lynch)"
    )

    logging.info("Check subject details against closure scenario SSCL4b(A166)")
