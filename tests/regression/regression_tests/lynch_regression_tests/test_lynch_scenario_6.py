...
def test_lynch_scenario_6(page: Page) -> None:
    """
    Scenario: 6 - Discharge no contact (no result)

    G1-G2-G3-A183-A25-J10-A99-A59-A259-A315-A361-A317-A318-A380-A354-A380-A100-A59-A172-A397-A391-A351-C203 Ceased over age [SSCL14b(A351)]
    ...
    # And I receive an SSPI update to change their date of birth to "80" years old
    SSPIChangeSteps().sspi_update_to_change_dob_received(nhs_no, 80)
