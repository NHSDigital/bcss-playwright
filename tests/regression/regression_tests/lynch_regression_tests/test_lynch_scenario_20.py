...
def test_lynch_scenario_20(page: Page) -> None:
    """
    Scenario: 20 - Unsuitable for symptomatic (with cease)

    G1-G2-G3-A183-A25-J10-A99-A59-A259-A315-A360-A410-A415-A416-A316-A348-A372-A357-A356-C203-Ceased by user overage [SSCL24d]
    ...
    logging.info("Make sure the subject is over the Lynch age range at recall")

    # When I view the subject
    screening_subject_page_searcher.navigate_to_subject_summary_page(page, nhs_no)

    # And I receive an SSPI update to change their date of birth to "88" years old
    SSPIChangeSteps().sspi_update_to_change_dob_received(nhs_no, 88)
