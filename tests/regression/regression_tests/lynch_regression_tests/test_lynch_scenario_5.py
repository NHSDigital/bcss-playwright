...
def test_scenario_5(page: Page) -> None:
    ...
    G1-G2-G3-A183-A25-J10-J15-J16-J17-C203 in age range [SSCL4c(J17)]
    ...
    logging.info("Check subject details against closure scenario SSCL4b(J17)")
