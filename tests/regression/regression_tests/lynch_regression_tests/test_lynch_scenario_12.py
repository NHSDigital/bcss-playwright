...
def test_lynch_scenario_12(page: Page) -> None:
    """
    Scenario: 12 - Abnormal result from diagnostic tests (below age)

    G1-G2-G3-A183-A25-J10-A99-A59-A259-A315-A361-A323-A317-A318-A65-Lynch below age [SSCL12c]
    ...
    logging.info("Make sure the subject is below the Lynch age range at recall")

    # When I view the subject
    screening_subject_page_searcher.navigate_to_subject_summary_page(page, nhs_no)

    # And I receive an SSPI update to change their date of birth to "20" years old
    SSPIChangeSteps().sspi_update_to_change_dob_received(nhs_no, 20)
    ...
    subject_assertion(
        nhs_no,
        {
            ...
            "lynch due date": "Null",
            "lynch due date date of change": "Today",
            "lynch due date reason": "Date of birth amendment",
