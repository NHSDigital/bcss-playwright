...
def test_scenario_4(page: Page) -> None:
    ...
    CreateSubjectSteps().update_subject_dob(nhs_no, new_age=45)

    # # And I pause for 5 seconds to let the process complete
    # page.wait_for_timeout(5000)

    # # When I run Timed Events for my subject
    # CallAndRecallUtils().run_timed_events(nhs_no)
    ...
    # CallAndRecallUtils().log_latest_unlogged_fit_kit(nhs_no)
    ...
    # CallAndRecallUtils().read_latest_logged_fit_kit(nhs_no, result="ABNORMAL")
